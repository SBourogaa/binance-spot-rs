...
use crate::Result;
use crate::{
    clients::{rest::BinanceSpotRestClient, r#trait::TickerClient},
    types::{
        requests::{
...
impl TickerClient for BinanceSpotRestClient {
    async fn ticker_price(
        ...
        self.request(reqwest::Method::GET, "/api/v3/ticker/price", specification)
            .await
    }
    ...
    async fn ticker_24hr(
        ...
        self.request(reqwest::Method::GET, "/api/v3/ticker/24hr", specification)
            .await
    }
    ...
    async fn ticker_rolling_window(
        ...
        self.request(reqwest::Method::GET, "/api/v3/ticker", specification)
            .await
    }
}
