...
use crate::Result;
use crate::{
    clients::{r#trait::TradingClient, websocket::BinanceSpotWebSocketClient},
    types::{
        requests::{
...
impl TradingClient for BinanceSpotWebSocketClient {
    ...
    async fn cancel_all_orders(
        ...
        self.signed_request("openOrders.cancelAll", specification)
            .await
    }
    ...
    async fn place_otoco_order(
        ...
        self.signed_request("orderList.place.otoco", specification)
            .await
    }
    ...
    async fn open_order_lists(
        ...
        self.signed_request("openOrderLists.status", specification)
            .await
    }
